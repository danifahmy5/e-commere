<div id="frame-tambah">
	<a class="btn btn-primary btn-sm float-right" href="<?php echo BASE_URL . "index.php?page=my_profile&module=kota&action=form"; ?>">+ Tambah Kota</a>
</div>
...
if (mysqli_num_rows($queryKota) == 0) {
	...
	echo "<tr class='baris-title bg-dark text-white'>
