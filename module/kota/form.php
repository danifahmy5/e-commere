...
<form action="<?php echo BASE_URL . "module/kota/action.php?kota_id=$kota_id" ?>" method="post">
	<div class="form-group">
		<label>Kota</label>
		<span><input type="text" class="form-control" name="kota" value="<?php echo $kota; ?>" /></span>
	</div>

	<div class="form-group">
		<label>Tarif</label>
		<span><input type="text" class="form-control" name="tarif" value="<?php echo $tarif; ?>" /></span>
	</div>
