...
<div class="table-responsive jumlah">
	...
	<div>silakan tranfer uang di rekening ini <strong>0700000899992</strong> dan lakukan konfirmasi di bawah ini</div>
	<a class="btn btn-primary " href="<?= BASE_URL."index.php?page=my_profile&module=pesanan&action=konfirmasi_pembayaran&pesanan_id=$pesanan_id"; ?>">disini</a>	
	</div>
</div>
