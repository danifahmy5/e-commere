...
admin_only("barang", $level);
  ...
  if($button == "Add") {
      mysqli_query($koneksi, "INSERT INTO barang (nama_barang, kategori_id, spesifikasi, gambar, harga, status)
                                            VALUES ('$nama_barang', '$kategori_id', '$spesifikasi', '$nama_file', '$harga', '$status')");
  }
...
// print_r($queryupdate);
  ...
  $delete = $_POST['barang_id'];

mysqli_query($koneksi, "DELETE FROM barang WHERE barang_id='$delete'");
}
